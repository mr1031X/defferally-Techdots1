import DocumentUploadForm from "@/app/ui/exchanges/documentUpload";
    ...
    return (
        <div className="w-full">
            <div className="flex w-full items-center justify-start p-6">
                <button className="rounded-md border-solid border-2 p-2">Step 2/4</button>
            </div>
            <DocumentUploadForm />
            <div className="flex w-full items-center justify-start p-6">
                <Link href="/dashboard/exchanges/create"
